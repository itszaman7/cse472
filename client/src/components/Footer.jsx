const Footer = () => {
  return (
    <div className="bg-gradient-to-b from-gray-900 to-black text-white">
      {/* Main Footer Content */}
      <footer className="footer px-10 py-12 max-w-7xl mx-auto">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
          {/* CrimeShield Brand Section */}
          <div className="space-y-4">
            ...
            <p className="text-gray-300">
              Empowering communities through collective safety and awareness.
            </p>
          ...
          <div>
            ...
            <p className="text-gray-300 mb-4">
              Subscribe to our safety alerts and community updates.
            </p>
            <div className="flex">
              <input
                type="email"
      ...
      <div className="border-t border-gray-800 py-6 px-10">
        <div className="max-w-7xl mx-auto flex flex-col md:flex-row justify-between items-center">
          <div className="text-gray-400 text-sm mb-4 md:mb-0">
            © {new Date().getFullYear()} CrimeShield Community. All rights
            reserved.
          </div>
